...
cf_dml <- function(numb_var,cont_var,expl_var,outc_var){
...
# TODO
# 1. Write naive_dml() and cf_dml() functions that we can reuse on new models
# 2. Use the raw data items of REP, INV, POL, FAML as "z" for naive_dml() and cf_dml()
